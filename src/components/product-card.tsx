    ...
    {product.price} per piece
        ...
        <div className="mt-auto grid grid-cols-2 gap-2 pt-2">
          <a
            ...
            className="inline-flex items-center justify-center rounded-full border border-primary bg-transparent px-3 py-2 text-xs font-semibold text-primary transition hover:bg-primary hover:text-primary-foreground"
          >
            Request Quote
          </a>
          <a
