...
function WholesalePage() {
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Bulk & B2B"
        title="Wholesale clay kulhads, straight from the kiln."
        subtitle="Hum cafés, dhabon, five-star hotels, shaadi planners aur exporters ko lagataar acchi quality aur bharosemand samay par supply karte hain."
      />
