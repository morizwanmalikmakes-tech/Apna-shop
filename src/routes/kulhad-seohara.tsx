  ...
  return (
    <SiteLayout>
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-muted-foreground">Seohara (Uttar Pradesh) — mitti ke kulhad wholesale aur bulk order. Seohara ki mandi aur tea stalls — wholesale kulhad ka fresh stock aur quick dispatch. Moradabad factory se approx 40 km — delivery 2-3 din me.</p>
