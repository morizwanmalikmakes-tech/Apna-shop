        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 md:grid-cols-2 md:items-center lg:px-8">
          ...
          <div>
            ...
            <p className="mt-4 text-secondary-foreground/80">
              Har Kulhad Factory ka kulhad Kanth ke kushal kumharo ke haathon se banta hai — Bharat ke mitti ke bartano ke dil se. Mitti taiyaar karne se lekar bhatti mein pakane tak, hum poore hunar par nazar rakhte hain, taaki aapko food-safe, majboot aur khushboo se bhare kulhad milen.
            </p>
